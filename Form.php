...
class Form extends Base
{
    ...
    public function getErrors()
    {
        $errors = array();
        if (session_id() == "") {
            $errors[""] = array("Error: The form project requires an active session to function properly.
                            Simply add session_start() to your script before any output has been sent to the browser.");
        } else {
            $errors = array();
...
JS;
    ...
    {
        $_SESSION["form"][$this->attributes["id"]]["form"] = serialize($this);
    }
